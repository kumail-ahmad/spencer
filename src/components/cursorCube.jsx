...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const moveHandler = (e) => {
      ...
      const hero = document.querySelector('section.z-30');
      const isOverHero = hero && hero.contains(e.target);
    ...
    const scrollHandler = () => {
      // Also hide if we scroll past hero height
    ...
    const mouseDownHandler = () => {
      if (!dotRef.current || document.body.style.cursor !== "none") return;
  ...
  return (
    <div
      ...
      style={{ willChange: "transform", mixBlendMode: "difference", opacity: 0 }}
    >
      <div
        ref={dotRef}
